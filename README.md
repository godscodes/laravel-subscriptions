# larvel Subscriptions

Upgrade to laravel 10

---
**Thanks**
Original repo [rinvex/laravel-subscriptions](https://github.com/rinvex/laravel-subscriptions)
...
1. Install the package via composer:
    ```shell
    composer require godscodes/laravel-subscriptions
    ```
